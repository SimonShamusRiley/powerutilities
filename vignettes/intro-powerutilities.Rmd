...
Now, we fit the model, but while fixing the residual standard deviation to 1.5 using the function `set_glmm`, which simplifies the syntax and help convert model terms to the correct parameterization, but which is otherwise just a wrapper for `glmmTMB`:
...
# Example 6: Gaussian Spatial Correlation Structure
